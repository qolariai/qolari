...
class SubscriptionPlanResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Planos Chat';

    protected static ?string $modelLabel = 'Plano de subscrição';

    protected static ?string $pluralModelLabel = 'Planos de subscrição';

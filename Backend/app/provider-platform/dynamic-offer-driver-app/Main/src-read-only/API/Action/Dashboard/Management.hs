...
import qualified API.Action.Dashboard.Management.Communication
import qualified API.Action.Dashboard.Management.DomainDiscountConfig
...
import qualified API.Action.Dashboard.Management.DriverVehicleQuality
...
import qualified API.Action.Dashboard.Management.KnowledgeCenter
...
import qualified API.Action.Dashboard.Management.QolariTag
...
import qualified API.Action.Dashboard.Management.VehicleDetails

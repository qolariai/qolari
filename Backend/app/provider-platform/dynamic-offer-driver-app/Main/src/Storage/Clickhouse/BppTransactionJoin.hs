...
data BppTransactionJoinT f = BppTransactionJoinT
  { bookingCustomerName :: C f (Maybe Text),
    ...
    bookingEstimatedDistance :: C f (Maybe Meters),
    rideTravelledDistance :: C f (Maybe HighPrecMeters),
...
bppTransactionJoinTTable =
  BppTransactionJoinT
    { bookingCustomerName = "booking_customer_name",
      ...
      bookingEstimatedDistance = "booking_estimated_distance",
      rideTravelledDistance = "ride_travelled_distance",
      rideFare = "ride_fare",
    ...
    mkRideItem bppTxn =
      QRE.RideItem
        { rideShortId = bppTxn.rideShortId,
          ...
          fare = mkPrice bppTxn.rideCurrency <$> bppTxn.rideFare,
          estimatedFare = mkPrice bppTxn.rideCurrency <$> bppTxn.bookingEstimatedFare,
          estimatedDistance = bppTxn.bookingEstimatedDistance,

...
module SharedLogic.External.LocationTrackingService.API.EndRide where
...
type LocationTrackingServiceAPI =
  "internal"
    ...
    :> Post '[JSON] EndRideRes

locationTrackingServiceAPI :: Proxy LocationTrackingServiceAPI
locationTrackingServiceAPI = Proxy

endRide :: Id DR.Ride -> EndRideReq -> ET.EulerClient EndRideRes
endRide = ET.client locationTrackingServiceAPI

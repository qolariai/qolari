...
import Kernel.Tools.Slack.Internal (SlackEnv, createSlackConfig)
...
data AppEnv = AppEnv
  { esqDBEnv :: EsqDBEnv,
    ...
    cacConfig :: CacConfig,
    kafkaProducerTools :: Kafka.KafkaProducerTools,
...
data AppCfg = AppCfg
  { esqDBCfg :: EsqDBConfig,
    ...
    cacheConfig :: CacheConfig,
    cacConfig :: CacConfig,
    kafkaProducerCfg :: Kafka.KafkaProducerCfg,
    secondaryKafkaProducerCfg :: Maybe Kafka.KafkaProducerCfg,
...
buildAppEnv authTokenCacheKeyPrefix AppCfg {..} = do
  ...
  kafkaProducerTools <- Kafka.buildKafkaProducerTools kafkaProducerCfg secondaryKafkaProducerCfg

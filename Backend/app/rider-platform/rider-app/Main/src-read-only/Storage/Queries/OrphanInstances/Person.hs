      ...
      Just
        Domain.Types.Person.Person
          { aadhaarVerified = aadhaarVerified,
            ...
            businessEmail = EncryptedHashed <$> (Encrypted <$> businessEmailEncrypted) <*> businessEmailHash,
            ...
            lastUsedVehicleServiceTiers = fromMaybe [] lastUsedVehicleServiceTiers,
            latestLat = latestLat,
            latestLon = latestLon,
  ...
  toTType' (Domain.Types.Person.Person {..}) = do
    Beam.PersonT
      { Beam.aadhaarVerified = aadhaarVerified,
        ...
        Beam.lastUsedVehicleServiceTiers = Just lastUsedVehicleServiceTiers,

...
WHERE table_schema = 'atlas_driver_offer_bpp'
  ...
  AND table_name NOT IN (
    ...
    'ride', 'rider_details', 'vehicle_registration_certificate', 'QOLARI_TAG'
  );

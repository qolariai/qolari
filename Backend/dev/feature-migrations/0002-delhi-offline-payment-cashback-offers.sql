...
BEGIN
  ...
  -- Enable useDomainOffers in Payment_Stripe, Payment_StripeTest, Payment_Qolari for Bharat Taxi
  ...
  RAISE NOTICE 'Bharat Taxi Delhi: useDomainOffers set to true for Stripe/StripeTest/Qolari';
END $$;

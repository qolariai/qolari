...
VALUES (
  ...
  'beabba6a-c817-43d2-93b2-a916f5cf2ceb',
  'Payout_StripeTest',
  '{"apiKey": "0.1.0|0|hMiwf44YibY/N5esKqfgy97pr+nB6zbGnr/HY4+iIAhihc+2d21CA4mrcCHnVvBPe5zlt5VLerKCiKhyl0k=", "returnUrl": "https://www.drive.qolari.com/return", "refreshUrl": "https://www.drive.qolari.com/refresh", "url": "http://localhost:8080/stripe/", "chargeDestination": "Platform", "serviceMode": "Test"}',
  now(), now()
) ON CONFLICT DO NOTHING;

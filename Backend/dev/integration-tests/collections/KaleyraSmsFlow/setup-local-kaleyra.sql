...
-- ============================================================
-- Rider App (atlas_app) — QOLARI / Bangalore
-- ============================================================
...
WHERE moc.merchant_short_id = 'QOLARI'
...
WHERE merchant_operating_city_id IN (
  ...
  WHERE merchant_short_id = 'QOLARI' AND city = 'Bangalore'
);
...
-- ============================================================
-- Driver App (atlas_driver_offer_bpp) — QOLARI_PARTNER / Bangalore
-- ============================================================
...
WHERE merchant_operating_city_id IN (
  ...
  WHERE merchant_short_id = 'QOLARI_PARTNER' AND city = 'Bangalore'
);

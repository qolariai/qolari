-- unencrypted: email: Qolari_admin@dashboard.com, password: Qolari_admin
...
SELECT
    ...
    'local-admin-token-bangalore-Qolari-yatri',
...
WHERE m.short_id = 'QOLARI_PARTNER'
ON CONFLICT DO NOTHING;
...
SELECT
    ...
    'local-fleet-token-bangalore-Qolari-yatri',
...
-- Grant the Qolari_ADMIN dev token cross-merchant + cross-city dashboard access.
DO $$
DECLARE

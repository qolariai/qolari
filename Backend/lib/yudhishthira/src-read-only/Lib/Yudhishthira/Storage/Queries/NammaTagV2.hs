...
module Lib.Yudhishthira.Storage.Queries.QolariTagV2 (module Lib.Yudhishthira.Storage.Queries.QolariTagV2, module ReExport) where
...
import Lib.Yudhishthira.Storage.Queries.QolariTagV2Extra as ReExport
...
create :: (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) => (Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2 -> m ())
create = createWithKV

createMany :: (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) => ([Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2] -> m ())
...
findAllByMerchantOperatingCityId ::
  ...
  (Kernel.Types.Id.Id Lib.Yudhishthira.Types.MerchantOperatingCity -> m ([Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2]))
...
findAllByPrimaryKeys ::
  (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) =>
  (Kernel.Prelude.Text -> Kernel.Types.Id.Id Lib.Yudhishthira.Types.MerchantOperatingCity -> m ([Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2]))
...
findByPrimaryKey ::
  (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) =>
  (Kernel.Types.Id.Id Lib.Yudhishthira.Types.MerchantOperatingCity -> Kernel.Prelude.Text -> m (Maybe Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2))
...
updateByPrimaryKey :: (Lib.Yudhishthira.Storage.Beam.BeamFlow.BeamFlow m r) => (Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2 -> m ())
updateByPrimaryKey (Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2 {..}) = do
  _now <- getCurrentTime
  updateWithKV

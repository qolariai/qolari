...
module Lib.Yudhishthira.Storage.Queries.QolariTagV2Extra where
...
import Lib.Yudhishthira.Storage.Queries.OrphanInstances.QolariTagV2
...
findAllByChakra ::
  ...
  m [Lib.Yudhishthira.Types.QolariTagV2.QolariTagV2]

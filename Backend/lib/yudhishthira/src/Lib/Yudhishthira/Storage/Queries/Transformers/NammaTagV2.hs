...
module Lib.Yudhishthira.Storage.Queries.Transformers.QolariTagV2 where
...
getChakra :: (Lib.Yudhishthira.Types.QolariTagV2.TagInfo -> Kernel.Prelude.Maybe Lib.Yudhishthira.Types.Chakra)
getChakra tag =
  case tag of
    Lib.Yudhishthira.Types.QolariTagV2.Application -> Kernel.Prelude.Nothing
    Lib.Yudhishthira.Types.QolariTagV2.KaalChakra (Lib.Yudhishthira.Types.QolariTagV2.KaalChakraTagInfo chakra) -> Just chakra
    Lib.Yudhishthira.Types.QolariTagV2.Manual -> Kernel.Prelude.Nothing

getTag :: (Lib.Yudhishthira.Types.QolariTagV2.TagInfo -> Lib.Yudhishthira.Types.QolariTagV2.TagType)
getTag tag =
  case tag of
    Lib.Yudhishthira.Types.QolariTagV2.Application -> Lib.Yudhishthira.Types.QolariTagV2.ApplicationTag
    Lib.Yudhishthira.Types.QolariTagV2.KaalChakra _ -> Lib.Yudhishthira.Types.QolariTagV2.KaalChakraTag
    Lib.Yudhishthira.Types.QolariTagV2.Manual -> Lib.Yudhishthira.Types.QolariTagV2.ManualTag
...
mkTagInfo :: (Kernel.Prelude.Maybe Lib.Yudhishthira.Types.Chakra -> Lib.Yudhishthira.Types.QolariTagV2.TagType -> Lib.Yudhishthira.Types.QolariTagV2.TagInfo)
mkTagInfo chakra tagType =
  case tagType of
    Lib.Yudhishthira.Types.QolariTagV2.ApplicationTag -> Lib.Yudhishthira.Types.QolariTagV2.Application
    Lib.Yudhishthira.Types.QolariTagV2.KaalChakraTag -> Lib.Yudhishthira.Types.QolariTagV2.KaalChakra (Lib.Yudhishthira.Types.QolariTagV2.KaalChakraTagInfo (fromMaybe Lib.Yudhishthira.Types.Monthly chakra))
    Lib.Yudhishthira.Types.QolariTagV2.ManualTag -> Lib.Yudhishthira.Types.QolariTagV2.Manual

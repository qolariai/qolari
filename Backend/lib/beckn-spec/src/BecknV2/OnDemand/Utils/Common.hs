...
mapServiceTierToCategory = \case
  ...
  E_RICKSHAW -> Enums.TOTO
  AUTO_LITE -> Enums.AUTO_RICKSHAW
  PINK_AUTO -> Enums.AUTO_RICKSHAW
...
getListOfServiceTireTypes Enums.AUTO_RICKSHAW = [DVST.AUTO_RICKSHAW, DVST.EV_AUTO_RICKSHAW, DVST.AUTO_PLUS, DVST.E_RICKSHAW, DVST.AUTO_LITE, DVST.PINK_AUTO]
...
getListOfServiceTireTypes Enums.BOAT = [DVST.BOAT]
getListOfServiceTireTypes Enums.TOTO = [DVST.E_RICKSHAW]
